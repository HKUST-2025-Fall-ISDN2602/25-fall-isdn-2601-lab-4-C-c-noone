...
void setup() {
  pinMode(32, OUTPUT);  // Set IN1 as an output pin
  pinMode(22, OUTPUT);  // Set IN2 as an output pin
  
  pinMode(4, OUTPUT); // Set TOUCH_PIN as an output pin
}

void loop() {
  touch_reading = touchRead(4); // Read the touch sensor
